...
### 因重大版本BUG，导致了管理员面板失效无法验证等问题 所以版本回滚到2.3，经测试小BUG不影响使用

 * 经过此事：深刻了反思了自己，步子不能迈的太大，真是修了一个BUG出现5个BUG，最后全盘崩溃，琢磨了很久最终还是决定回档吧，反而第一个版本是没什么问题的，基本上的功能都有了

 * 后续我会慢慢的测试功能，不再高频率更新内容，尽量以稳定为主，需要新的功能的可以自己找AI添加

 * 如果使用了新的代码，我都十分的建议用这个稳定的版本
